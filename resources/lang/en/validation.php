...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'data.attributes.recipient_address.first_name'           => 'recipient\'s first name',
        'data.attributes.recipient_address.last_name'            => 'recipient\'s last name',
        ...
        'data.attributes.recipient_address.phone_number'         => 'recipient\'s phone number',
        ...
        'data.attributes.sender_address.first_name'           => 'sender\'s first name',
        'data.attributes.sender_address.last_name'            => 'sender\'s last name',
        'data.attributes.sender_address.company'              => 'sender address company',
        'data.attributes.sender_address.email'                => 'sender\'s email address',
        'data.attributes.sender_address.phone_number'         => 'sender\'s phone number',
        ...
        'data.attributes.sender_tax_number' => 'shipment\'s sender tax number',
        'data.attributes.description' => 'shipment\'s description',

        'data.attributes.service.code' => 'used service code',
        'data.attributes.service.name' => 'used service\'s name',

        'data.attributes.options.*.code' => 'service option codes',
        'data.attributes.options.*.name' => 'service option names',
